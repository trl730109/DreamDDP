...
if __name__ == "__main__":
    ...
    for server in servers:
        for model in models:
            ...
            print(f'Server: {server}, Model: {model}, Current Bandwidth: {current_bandwidth}')
            ...
            print(f'total communication time: {total_comm_time}')
            print(f'total bp time: {total_bp_time}')
            ...
            sgd_time_per_iter = cal_sgd(total_iterations, total_bp_time, total_comm_time)
            pipe_sgd_time_per_iter = cal_pipe_sgd(total_iterations, total_bp_time, total_comm_time)
            localsgd_time_per_iter = cal_localsgd(total_iterations, nsteps_localsgd, total_bp_time, total_comm_time)
            dreamddp_time_per_iter = cal_dreamddp(total_iterations, nsteps_localsgd, dreamddp_extra_comm_time, total_bp_time)
            pipe_seq_localsgd_time_per_iter = cal_pipe_seq_localsgd(total_iterations, nsteps_localsgd, plsgd_wait_list, total_bp_time)
            
            print(f'----------------------- Final results -----------------------')
            print(f'SGD time per iter: {sgd_time_per_iter}')
            print(f'Pipe SGD time per iter: {pipe_sgd_time_per_iter}')
            print(f'Localsgd time per iter: {localsgd_time_per_iter}')
            print(f'Dreamddp time per iter: {dreamddp_time_per_iter}')
            print(f'Pipe seq Localsgd time per iter: {pipe_seq_localsgd_time_per_iter}')
            print()
