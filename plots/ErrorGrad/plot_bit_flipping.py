...
def run_convergence_vs_worker_modeltype_fixed_noise(worker, model):
    CIFAR10_RES18 = f"acc_{worker}workers_{model}_bit_flipping"
    if model == "resnet18":
        build_run("hpml-hkbu/DDP-Train/l9e8lv4q", CIFAR10_RES18,
        {"": ""}, "sgd-noiFalse-resnet18-SGD-lr0.1")
        
        build_run("hpml-hkbu/DDP-Train/ouo07bm2", CIFAR10_RES18,
        {"": ""}, "sgd-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001")
        ### fix not clip
        build_run("hpml-hkbu/DDP-Train/wfju7yau", CIFAR10_RES18,
        {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP10-clipFalse")
        
        build_run("hpml-hkbu/DDP-Train/y4wum6ry", CIFAR10_RES18,
        {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP10")
        
        build_run("hpml-hkbu/DDP-Train/b08ge5su", CIFAR10_RES18,
        {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP10-clipTrue-clip_value_min-0.1-clip_value_max0.1-Detectbase")
    ...
    simple_name = f"bit_flipping-cifar10_{model}_{worker}workers--convergence_vH"
    markers = [None] * 7
    linestyles = [None] * 7
    # markers = ['o']*2 + ['v']*2 + ['D']*2
    # linestyles = ["-"] * 2 + ["--"] * 2 + [":"] * 3
...
#         build_run("hpml-hkbu/DDP-Train/5v7cuvfk", CIFAR10_RES18,
#         {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP5-clipTrue-clip_value_min-0.1-clip_value_max0.1")
        
#         build_run("hpml-hkbu/DDP-Train/jxp1kmhw", CIFAR10_RES18,
#         {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP10-clipTrue-clip_value_min-0.1-clip_value_max0.1")
        
#         build_run("hpml-hkbu/DDP-Train/z56o96xy", CIFAR10_RES18,
#         {"": ""}, "sgd_with_sync-noiTrue-tfix-resnet18-lora-nw8-SGD-LG20-lr0.1-bs128-params_flip0.1-flip_prob0.1-bit_flip_interval500-nstd0.0001-SyncP5-clipTrue-clip_value_min-0.1-clip_value_max0.1-Detectbase")
