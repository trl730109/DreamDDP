...
def run_convergence_vs_worker_modeltype_fixed_noise(worker, model):
    ...
    # build_run("hpml-hkbu/DDP-Train/mrgtyffn", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd1.0")
    build_run("hpml-hkbu/DDP-Train/no8b262y", CIFAR10_RES18,
    {"": ""}, "sgd-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd0.1")
    build_run("hpml-hkbu/DDP-Train/tukdyjz5", CIFAR10_RES18,
    {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd0.1-SyncP10")
    build_run("hpml-hkbu/DDP-Train/q5be69f3", CIFAR10_RES18,
    {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd0.1-SyncP20")
    # build_run("hpml-hkbu/DDP-Train/90wavij5", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd1.0-SyncP20")
    build_run("hpml-hkbu/DDP-Train/ygtefd8z", CIFAR10_RES18,
    {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-SGD-LG20-lr0.01-bs4-nstd0.1-SyncP10")



    simple_name = f"cifar10_{model}_{worker}workers_convergence_vH"
    markers = [None] * 7
    linestyles = [None] * 7
    # markers = ['o']*2 + ['v']*2 + ['D']*2
    # linestyles = ["-"] * 2 + ["--"] * 2 + [":"] * 3
