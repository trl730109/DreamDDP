...
if __name__ == '__main__':
    ...
    # gpt2 4 workers
    # build_run("hpml-hkbu/DDP-Train/xft2xruq", CIFAR10_RES18,
    ...
    # build_run("hpml-hkbu/DDP-Train/fjosqy3h", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.001")
    # build_run("hpml-hkbu/DDP-Train/yqpdcorc", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.01")
    # build_run("hpml-hkbu/DDP-Train/04z43sq1", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.1")
    # build_run("hpml-hkbu/DDP-Train/uy6wjyu9", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd1.0")
    ...
    # build_run("hpml-hkbu/DDP-Train/k96uv8jp", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/s59c3f42", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/6expnfrl", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/difaxre4", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw4-Adam-LG20-lr0.0001-bs4-nstd1.0-SyncP5-detect")

    # llama
    build_run("hpml-hkbu/DDP-Train/eba5bwbs", CIFAR10_RES18,
    {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.0001")
    # build_run("hpml-hkbu/DDP-Train/efd47rtf", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.001")
    # build_run("hpml-hkbu/DDP-Train/w6f79of0", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.01")
    # build_run("hpml-hkbu/DDP-Train/9m88lutr", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.1")
    # build_run("hpml-hkbu/DDP-Train/p600kp0j", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd1.0")
    # build_run("hpml-hkbu/DDP-Train/p600kp0j", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd1.0")
    ...
    # build_run("hpml-hkbu/DDP-Train/4eqxbcy0", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/6tbb6bp1", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/giwleqk4", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP5-detect")
    # build_run("hpml-hkbu/DDP-Train/hd1qctr1", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw4-Adam-LG20-lr0.0001-bs4-nstd1.0-SyncP5-detect")

    # gpt2
    # build_run("hpml-hkbu/DDP-Train/lbtauptr", CIFAR10_RES18,
    ...
    # build_run("hpml-hkbu/DDP-Train/kzexx8o6", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001")
    # build_run("hpml-hkbu/DDP-Train/b9280ied", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01")
    # build_run("hpml-hkbu/DDP-Train/7e7n1evq", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1")
    ...
    # build_run("hpml-hkbu/DDP-Train/s6jejn2b", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/xrdmo233", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/mdqdwypy", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP5")
    ...
    # build_run("hpml-hkbu/DDP-Train/isy3tm8h", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/7wcl0u65", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/ujbsm3fx", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP10")
    ...
    # build_run("hpml-hkbu/DDP-Train/uqggt7fm", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP50")
    # build_run("hpml-hkbu/DDP-Train/mgti9cto", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP50")
    # build_run("hpml-hkbu/DDP-Train/bjozaymd", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP50")

    # gpt2 -detect
    # build_run("hpml-hkbu/DDP-Train/odq7j5fe", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.0001-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/sdtom9ym", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/yfdfwmdb", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/rmuqmkgb", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP5")
    ...
    # build_run("hpml-hkbu/DDP-Train/mjecl21w", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/mg04r0y3", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/avit7g91", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-gpt2-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP10")

    # llama 32 
    # build_run("hpml-hkbu/DDP-Train/cxpfp7dk", CIFAR10_RES18,
    ...
    # build_run("hpml-hkbu/DDP-Train/7id0m4lc", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001")
    # build_run("hpml-hkbu/DDP-Train/y11tur6o", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01")
    # build_run("hpml-hkbu/DDP-Train/wjse25ac", CIFAR10_RES18,
    # {"": ""}, "sgd-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1")
    ...
    # build_run("hpml-hkbu/DDP-Train/sgnv5bj5", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/ipfhnlpg", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP5")
    # build_run("hpml-hkbu/DDP-Train/nvrodd4o", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP5")
    ...
    # build_run("hpml-hkbu/DDP-Train/cd02g5j3", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/kl9y82j9", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP10")
    # build_run("hpml-hkbu/DDP-Train/vbg4hh40", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP10")
    ...
    # build_run("hpml-hkbu/DDP-Train/bh6hng4o", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.001-SyncP50")
    # build_run("hpml-hkbu/DDP-Train/o2wxf3dj", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.01-SyncP50")
    # build_run("hpml-hkbu/DDP-Train/ewv7bz3t", CIFAR10_RES18,
    # {"": ""}, "sgd_with_sync-noiTrue-llama2-124M-nw32-Adam-LG20-lr0.0001-bs4-nstd0.1-SyncP50")
