...
# python3 Scheduling/dreamddp_scheduling.py /workspace/tzc/DreamDDP/time_tmp/llama2-124M/8 --H 10 --bp_multiplier ${BP_MULTIPLIER} --comm_multiplier 1


# python3 Scheduling/dreamddp_scheduling.py /workspace/tzc/DreamDDP/time/Qwen2.5-7B/8 --H 10 --bp_multiplier ${BP_MULTIPLIER} --comm_multiplier 1

# python3 Scheduling/dreamddp_scheduling.py /workspace/tzc/DreamDDP/time/resnet18/8 --H 10 --bp_multiplier 10 --comm_multiplier 20

# python3 Scheduling/dreamddp_scheduling.py /workspace/tzc/DreamDDP/time/resnet50/8 --H 10 --bp_multiplier 10 --comm_multiplier 10



# python3 Scheduling/dreamddp_scheduling.py /workspace/tzc/DreamDDP/time/gpt2/32 --H 10 --bp_multiplier ${BP_MULTIPLIER} --comm_multiplier 1
