...
#OUTPUTPATH='/media/sf_Shared_Data/tmp/ijcai2019'
OUTPUTPATH='/media/sf_Shared_Data/tmp/p2psgd'
...
def plot_group_norm_diff():
    ...
    #plt.subplots_adjust(bottom=0.08, left=0.08, right=0.90, top=0.89, wspace=0.49, hspace=0.33)
...
def plot_norm_diff(lax=None, network=None, subfig=None):
    ...
    if network == 'lstm':
        ...
        #line = plot_with_params(network, 4, 256, lr, 'gpu16', 'S-SGD loss', prefix='allreduce-baseline-gwarmup-dc1-model-general', nsupdate=1, force_legend=True)
