...
def plot_convergence(lax=None, network=None, subfig=None):
    ...
    if network == 'lstm':
        ...
        lr=1.0
        line = plot_with_params(network, 1, bs, lr, 'scigpu11', r'Dense-SGD (P=1,bs=%d,lr=%f)'%(bs, lr), isacc=isacc, prefix='singlegpu-gwarmup-dc1-model-nips2020', nsupdate=1, force_legend=True, force_color='black')
        lr=2.0
        line = plot_with_params(network, 1, bs, lr, 'scigpu11', r'Dense-SGD (P=1,bs=%d,lr=%f)'%(bs, lr), isacc=isacc, prefix='singlegpu-gwarmup-dc1-model-nips2020', nsupdate=1, force_legend=True, force_color='black')
        ...
        for nworkers in nworkers_list:
            ...
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'Dense-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color='r')
        ...
        #    line = plot_with_params(network, nworkers, bs, lr, 'scigpu12', r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        ...
        for nworkers in nworkers_list:
            update='convergence';lr=0.1
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopK-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='y')
        ...
        for nworkers in nworkers_list:
            ...
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopKDD-SGD+MC (P=%d,bs=%d,lr=%f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='blue')
        ...
        for nworkers in nworkers_list:
            update='convergence';lr=0.1
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopKDecay-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdecay-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='orange')
            update='convergence';lr=0.566
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopKDecay-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdecay-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='orange')
            update='convergence';lr=3.2
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopKDecay-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdecay-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='orange')
        ...
        #    #update='r1'
        #    update='convergence';lr=0.1
        #    line = plot_with_params(network, nworkers, bs, lr, 'scigpu13', r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        #    update='convergence';lr=0.566
        #    line = plot_with_params(network, nworkers, bs, lr, 'scigpu13', r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        #    update='convergence';lr=3.2
        #    line = plot_with_params(network, nworkers, bs, lr, 'scigpu13', r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        ...
        for nworkers in nworkers_list:
            ...
            #lr=3.2;update='convergence'
            #line = plot_with_params(network, nworkers, bs, lr, 'scigpu11', r'Dense-SGD (P=%d,lr=%.4f)'%(nworkers,lr), isacc=isacc, prefix='allreduce-baseline-gwarmup-dc1-gtopkjournal-%s'%update, nsupdate=1, force_legend=True, force_color='r')
            #line = plot_with_params(network, nworkers, bs, lr, 'scigpu12', r'Dense-SGD (P=%d,lr=%f)'%(nworkers,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color='r')
            lr=0.566;update='convergence'
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'Dense-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color='r')
            #line = plot_with_params(network, nworkers, bs, lr, 'scigpu11', r'Dense-SGD (P=%d,lr=%.4f)'%(nworkers,lr), isacc=isacc, prefix='allreduce-baseline-gwarmup-dc1-gtopkjournal-%s'%update, nsupdate=1, force_legend=True, force_color='r')
            lr=3.2;update='convergence'
        ...
        for nworkers in nworkers_list:
            ...
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
            lr=0.566
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
            lr=3.2
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopK-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        ...
        for nworkers in nworkers_list:
            ...
            #update='convergence';lr=3.2
            #line = plot_with_params(network, nworkers, bs, lr, 'scigpu13', r'EFTopK-SGD+MC (P=%d,lr=%.4f)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-comp-eftopk-baseline-gwarmup-dc1-gtopkjournal-%s'%update, nsupdate=1, sg=2.5, density=density, force_legend=True,force_color='g')
            #line = plot_with_params(network, nworkers, bs, lr, 'scigpu12', r'EFTopK-SGD (P=%d,lr=%f)'%(nworkers,lr), isacc=isacc, prefix='allreduce-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='g')
        ...
        for nworkers in nworkers_list:
            ...
            update='convergence';lr=0.1
            line = plot_with_params(network, nworkers, bs, lr, hostname, r'EFTopKDD-SGD+MC(P=%d,bs=%d,lr=%.4f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,bs,lr),isacc=isacc,  prefix='allreduce-mc-comp-eftopkdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True,force_color='blue')
        ...
        for nworkers in nworkers_list:
            ...
            line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'Dense-SGD (P=%d,bs=%d,lr=%.4f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color='r')
        ...
        for nworkers in nworkers_list:
            ...
            #line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopK-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='y')
            lr=0.8
            line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopK-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='y')
            lr=1.2
            line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopK-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopk-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='y')
        ...
        for nworkers in nworkers_list:
            #update='convergence';lr=0.1
            #line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopKDD-SGD+MC(P=%d,bs=%d,lr=%.4f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,bs,lr),isacc=isacc,  prefix='allreduce-mc-comp-eftopkdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True,force_color='blue')
            update='convergence';lr=0.8
            line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopKDD-SGD+MC(P=%d,bs=%d,lr=%.4f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,bs,lr),isacc=isacc,  prefix='allreduce-mc-comp-eftopkdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True,force_color='blue')
            #version='eftopkddr4'
            #line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopKDD-SGD+MC(P=%d,bs=%d,lr=%.4f,%s)'%(nworkers,bs,lr,version),isacc=isacc,  prefix='allreduce-mc-comp-%s-gwarmup-dc1-model-nips2020-thres-512000kbytes'%version, nsupdate=1, density=density, force_legend=True,force_color='blue')

        markeriter = itertools.cycle(markers)
        for nworkers in nworkers_list:
            #update='convergence';lr=0.1
            #line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopKDecay-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdecay-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='orange')
            update='convergence';lr=0.8
            line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFTopKDecay-SGD+MC (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-eftopkdecay-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=density, force_legend=True, force_color='orange')
        ...
        #for nworkers in nworkers_list:
        #    update='convergence';lr=0.1
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        #    update='convergence';lr=0.8
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=0.2,MAX_DELAY=1.3)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        #    update='r1';lr=0.8
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=0.3,MAX_DELAY=1.8)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-%s-thres-512000kbytes'%update, nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        #    update='r2';lr=0.8
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=1,MAX_DELAY=6)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-%s-thres-512000kbytes'%update, nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        #    update='r3';lr=0.8
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=1,MAX_DELAY=20)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-%s-thres-512000kbytes'%update, nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        #    update='r4';lr=0.8
        #    line = plot_with_params(network, nworkers, bs, lr, 'gpu9', r'EFDGCDD-SGD+MC(P=%d,lr=%.4f,ADD=1,MAX_DELAY=200)'%(nworkers,lr),isacc=isacc,  prefix='allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-%s-thres-512000kbytes'%update, nsupdate=1, sg=None, density=density, force_legend=True,force_color='blue')
        pass
        ...
        #update='convergence'
        line = plot_with_params(network, 1, bs, lr, 'scigpu10', r'Dense-SGD (P=1,BS=%d,lr=%.4f)'%(bs,lr), isacc=isacc, prefix='singlegpu-gwarmup-dc1-model-nips2020', nsupdate=1, force_legend=True, force_color='black')
        update='convergence'
        markeriter = itertools.cycle(markers)
        for nworkers in nworkers_list:
            #'allreduce-baseline-gwarmup-dc1-gtopkjournal-convergence/resnet50-n32-bs64-lr0.1000-ns1'
            lr=0.16
            line = plot_with_params(network, nworkers, bs, lr, 'scigpu11', r'Dense-SGD (P=%d,lr=%.4f)'%(nworkers,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-hvd-thres-512000kbytes', nsupdate=1, force_legend=True, force_color='r', density=1.0)
    return plts
...
def best_to_best(lax=None, network=None, subfig=None):
    ...
    for idx, compressor in enumerate(compressors):
        lr = lrs[idx]
        if compressor == 'none':
            _, acc = plot_with_params(network, nworkers, bs, lr, hostname, r'Dense-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color=fixed_colors[compressor])
        else:
            _, acc = plot_with_params(network, nworkers, bs, lr, hostname, r'%s w/ MC (P=%d,bs=%d,lr=%f)'%(compressor, nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-%s-gwarmup-dc1-model-nips2020-thres-512000kbytes'%compressor, nsupdate=1, density=density, force_legend=True, force_color=fixed_colors[compressor])
...
def plot_convergence_new(lax=None, network=None, subfig=None):
    ...
    if network in ['resnet20', 'resnet110', 'vgg16']:
        ...
        hostname='scigpu12';nworkers=4;bs=32
    ...
    for compressor in compressors:
        ...
        for lr in lrs:
            try:
                if compressor == 'none':
                    _, acc, std = plot_with_params(network, nworkers, bs, lr, hostname, r'Dense-SGD (P=%d,bs=%d,lr=%f)'%(nworkers,bs,lr), isacc=isacc, prefix='allreduce-gwarmup-dc1-model-nips2020-thres-512000kbytes', nsupdate=1, density=1.0, force_legend=True, force_color=fixed_colors[compressor])
                elif compressor.find('womc') > 0:
                    _, acc, std = plot_with_params(network, nworkers, bs, lr, hostname, r'%s w/o MC (P=%d,bs=%d,lr=%f)'%(compressor, nworkers,bs,lr), isacc=isacc, prefix='allreduce-comp-%s-gwarmup-dc1-model-nips2020-thres-512000kbytes'%compressor.split('-')[0], nsupdate=1, density=density, force_legend=True, force_color=fixed_colors[compressor])
                else:
                    _, acc, std = plot_with_params(network, nworkers, bs, lr, hostname, r'%s (P=%d,bs=%d,lr=%f)'%(compressor, nworkers,bs,lr), isacc=isacc, prefix='allreduce-mc-comp-%s-gwarmup-dc1-model-nips2020-thres-512000kbytes'%compressor, nsupdate=1, density=density, force_legend=True, force_color=fixed_colors[compressor])
                if max_acc < acc:
                    max_acc = acc
                    max_std = std
                    max_lr = lr
