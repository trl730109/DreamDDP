...
#$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-debug-thres-512000kbytes/resnet50-n32-bs64-lr0.1000 --dnn resnet50 --dataset imagenet --nepochs 90 --data-dir /localdata/ILSVRC2012_dataset
#$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-thres-512000kbytes/resnet50-n32-bs64-lr0.8000 --dnn resnet50 --dataset imagenet --nepochs 90 --data-dir /localdata/ILSVRC2012_dataset
#$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-r1-thres-512000kbytes/resnet50-n32-bs64-lr0.8000 --dnn resnet50 --dataset imagenet --nepochs 93 --data-dir /localdata/ILSVRC2012_dataset
#$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-r2-thres-512000kbytes/resnet50-n32-bs64-lr0.8000 --dnn resnet50 --dataset imagenet --nepochs 93 --data-dir /localdata/ILSVRC2012_dataset
#$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-r3-thres-512000kbytes/resnet50-n32-bs64-lr0.8000 --dnn resnet50 --dataset imagenet --nepochs 93 --data-dir /localdata/ILSVRC2012_dataset
$PY evaluate.py --model-path weights/allreduce-mc-comp-dgcsamplingdd-gwarmup-dc1-model-nips2020-r4-thres-512000kbytes/resnet50-n32-bs64-lr0.8000 --dnn resnet50 --dataset imagenet --nepochs 93 --data-dir /localdata/ILSVRC2012_dataset
