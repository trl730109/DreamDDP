...
def plot_convergence(lax=None, network=None, subfig=None):
    ...
    if network == 'lstm':
        ...
        density=1.0
        line = plot_with_params(network, 16, 32, lr, 'gpu10', r'Dense-SGD', isacc=isacc, prefix='allreduce-baseline-gwarmup-dc1-model-nips-layerwise-speedk80-adaptive', nsupdate=1, density=density, force_legend=True, force_color='r')
        plts.append(line)
        density=0.001
